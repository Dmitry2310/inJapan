...
const CreatePost = ({ post, setIsChanging }) => {
                ...
                <form autoComplete="off" onSubmit={handleSubmit}>
                    <Grid container gap={2} sx={{ flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-around' }}>
                        <Grid item xs={12} sm={6}>
                            ...
                            <Typography sx={{ paddingLeft: '15px', opacity: '0.8', marginTop: '25px' }}>{t("Your_Article")}</Typography>
                        ...
                        <Grid item xs={12} sm={5}>
                            <Grid container gap={2} sx={{ padding: '5px' }}>
                                <Grid item xs={12} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
                                    ...
                                    <Card sx={{ maxWidth: '80%', minWidth: '40%', margin: '0 auto' }} elevation={3}>
                                        <CardMedia
                                            component="img"
                                            alt={'picture'}
                                            height="220px"
                                    ...
                                    <Box>
                                        ...
                                        <Button variant='contained' onClick={handleClick}>{(post?.selectedFile || selectedImage) ? t("Change_cover_Image") : t("Upload_cover_Image")}</Button>
                                    </Box>
                                </Grid>
                                <Grid item xs={12}>
                        ...
                        <Grid item xs={12}>
                            <Box sx={{ display: 'flex', width: '100%', justifyContent: { md: 'flex-end' }, flexDirection: { xs: 'column', md: 'row' } }}>
                                ...
                                < Button variant="contained" color="secondary" size="medium" sx={{ margin: '10px', marginRight: { md: '5%' } }} onClick={() => setIsChanging(false)} >{t("Cancel")}</Button>
                            </Box>
                        </Grid>
                    </Grid>
                </form>
